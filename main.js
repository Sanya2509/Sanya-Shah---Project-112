...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/_hqXzFZWW/model.json',modelLoaded);
...
function gotResults(error, results){
    if(error){
        ...
        if(results[0].label == "Amazing"){
            ...
            document.getElementById("quote").innerHTML = "That is Amazing!";
        }
